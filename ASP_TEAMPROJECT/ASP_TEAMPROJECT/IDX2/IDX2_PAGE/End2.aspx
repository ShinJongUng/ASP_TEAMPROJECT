<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="End2.aspx.cs" Inherits="ASP_TEAMPROJECT.IDX2.IDX2_PAGE.End2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style5">
        <tr>
            <td class="auto-style6"><strong>좋아하는 음식 월드컵 결과<img alt="" style="z-index: 1" class="auto-style8" src="../../IDX1/IDX1_IMG/free-icon-trophy-1021194.png" /></strong></td>
        </tr>
        <tr>
                ...
                <img alt="" style="z-index: 1" class="auto-style8" src="../../IDX1/IDX1_IMG/free-icon-trophy-1021194.png" /><img alt="" style="z-index: 1" class="auto-style8" src="../../IDX1/IDX1_IMG/free-icon-trophy-1021194.png" /><table class="auto-style9">
                    <tr>
                        <td class="auto-style11" colspan="2"><strong>
                            <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="~/App_Data/Chat2.xml"></asp:XmlDataSource>
                            댓글</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    </tr>
                    <tr>
